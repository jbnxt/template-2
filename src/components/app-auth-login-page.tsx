            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-airbnb-teal focus:ring-airbnb-teal border-gray-300 rounded"
                />
              ...
              <div className="text-sm">
                <Link href="/auth/reset-password" className="font-medium text-airbnb-teal hover:text-airbnb-teal-dark">
